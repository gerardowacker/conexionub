          ...
          <section className="catalog">
            ...
            <div className="cards-2">
              <article className="career-card">
                <div className="thumb" 
                style={{ backgroundImage: `linear-gradient(to bottom, rgba(134,28,36,.25), rgba(134,28,36,0)), url(${imgInf})`,
                        backgroundSize: "cover",
                        backgroundPosition: "center", }}/>
                <h3>Ingeniería en Informática</h3>
                <span className="years"> 5 años</span>
                <p>Dominá la gestión de datos, procesos y automatización en organizaciones modernas.</p>
                <a className="btn" href="/carreras/ingenieria-informatica">Ver más</a>
              </article>

              <article className="career-card">
                <div className="thumb"
                style={{ backgroundImage: `linear-gradient(to bottom, rgba(134,28,36,.25), rgba(134,28,36,0)), url(${imgLic})`,
                        backgroundSize: "cover",
                        backgroundPosition: "center", }}/>
              ...
              <article className="career-card">
                ...
                <p>Aprendé a programar desde cero y creá software ágil y funcional para multiples entornos.</p>
              ...
              <article className="career-card">
                ...
                <span className="years"> 4 años</span>
                <p>Conocé el impacto de la alimentación en la salud y ayudá a transformar hábitos de vida.</p>
              ...
              <article className="career-card">
                ...
                <span className="years"> 4 años</span>
                <p>Explorá el mundo natural desde la genética hasta la ecología con enfoque científico y aplicado.</p>
              ...
              <article className="career-card">
                ...
                <span className="years"> 4 años</span>
                <p>Especializate en medicamentos, control de calidad y contribución al cuidado de la salud.</p>
              ...
              <article className="career-card">
                ...
                <span className="years"> 2½ años</span>
                <p>Uni creatividad y tecnología para dar vida a experiencias visuales interactivas.</p>
